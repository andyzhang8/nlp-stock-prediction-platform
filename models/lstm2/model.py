...
class StockLSTM(nn.Module):
    def __init__(self, num_companies, embedding_dim=32, input_dim=4, hidden_dim=64, num_layers=2, dropout=0.2):
    ...
    def forward(self, company_id, x: torch.Tensor):
        ...
        company_embedding = company_embedding.unsqueeze(1).repeat(1, x.shape[1], 1)  
